...
-- Check [dim_reading_mode count matches tb_readingmode]
WITH dwh_ct AS (SELECT COUNT(*) AS c FROM dim_reading_mode),
     stg_ct AS (SELECT COUNT(*) AS c FROM tb_readingmode)
